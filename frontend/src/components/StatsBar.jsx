...
function StatsBar() {
  ...
  return (
    <section className="px-4 md:px-16 my-8">
      <div className="max-w-[1100px] mx-auto bg-gray-900 rounded-3xl px-8 py-10 shadow-2xl relative overflow-hidden">
          ...
          {features.map((feature, i) => (
            <div
              ...
              className={`flex flex-col items-center text-center opacity-0 animate-fade-in-up duration-500 hover:-translate-y-1 transition-transform
                ${i > 0 ? 'sm:border-l sm:border-gray-800' : ''}
              `}
              style={{ animationDelay: `${i * 0.1}s` }}
            >
              <div className="text-indigo-400 mb-4 bg-gray-800/80 p-3.5 rounded-2xl shadow-inner border border-gray-700/50">
                {feature.icon}
              </div>
